...
export const generateSampleProducts = (userId: string): Product[] => {
  ...
  return [
    {
      id: 'prod-1', name: 'Coca Cola 50cl', purchasePrice: 0.6, salePrice: 1, stock: 48,
      category: 'drinks', userId, createdAt: now, updatedAt: now, synced: false,
    },
    {
      id: 'prod-2', name: 'Pain (Baguette)', purchasePrice: 0.3, salePrice: 0.5, stock: 25,
      category: 'food', userId, createdAt: now, updatedAt: now, synced: false,
    },
    {
      id: 'prod-3', name: 'Savon Lux', purchasePrice: 0.9, salePrice: 1.5, stock: 15,
      category: 'cosmetics', userId, createdAt: now, updatedAt: now, synced: false,
    },
    {
      id: 'prod-4', name: 'Riz 1kg', purchasePrice: 1.8, salePrice: 2.5, stock: 30,
      category: 'food', userId, createdAt: now, updatedAt: now, synced: false,
    },
    {
      id: 'prod-5', name: 'Primus Biere', purchasePrice: 1.2, salePrice: 2, stock: 60,
      category: 'drinks', userId, createdAt: now, updatedAt: now, synced: false,
    },
    {
      id: 'prod-6', name: 'Chemise Homme', purchasePrice: 6, salePrice: 10, stock: 8,
      category: 'clothes', userId, createdAt: now, updatedAt: now, synced: false,
    },
    {
      id: 'prod-7', name: 'Huile de cuisine 1L', purchasePrice: 3.5, salePrice: 5, stock: 12,
      category: 'food', userId, createdAt: now, updatedAt: now, synced: false,
    },
    {
      id: 'prod-8', name: 'Fanta Orange', purchasePrice: 0.6, salePrice: 1, promotionPrice: 0.8, stock: 4,
      category: 'drinks', userId, createdAt: now, updatedAt: now, synced: false,
    },
    {
      id: 'prod-9', name: 'Pagne Wax', purchasePrice: 10, salePrice: 15, stock: 6,
      category: 'clothes', userId, createdAt: now, updatedAt: now, synced: false,
    },
    {
      id: 'prod-10', name: 'Lait Nido', purchasePrice: 5, salePrice: 7, stock: 20,
      category: 'food', userId, createdAt: now, updatedAt: now, synced: false,
    },
  ];
};
